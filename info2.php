...
<div class="bar-card">
  <a href="#" id="prev">&lt;</a>
  <a href="info1.php" class="page" data-page="1">1</a>
  <a href="info2.php" class="page" data-page="2" style="color: red;">2</a>
...
<script>
  // ดึงหน้าปัจจุบันจาก URL เช่น how2.php => 2
  const currentFile = window.location.pathname.split("/").pop(); // ได้ชื่อไฟล์ เช่น how2.php
  const match = currentFile.match(/info(\d+)\.php/);
  let currentPage = match ? parseInt(match[1]) : 1;

  function goToPage(page) {
    window.location.href = `info${page}.php`;
  }
