...
<div class="border-contact">
    ...
    <div class="contact-text">
        ...
        <p>คอนกรีตพิมพ์ลาย รุ่น 13</p>
        <p>สถานที่ : ชลบุรี อ.บางละมุง</p>
        <p>วันเสาร์ที่ : 22 มีนาคม 2568</p>
    </div>

    <div class="contact-button">
        <a href="detail.php" style="color: white; background-color: blue;">ดูรายละเอียดเพิ่มเติม</a><br>
        <a href="https://lin.ee/HqRQQAB" style="color: white; background-color: green;" >สมัครทางไลน์</a>
    </div>
</div>
    ...
    <div class="sec-text">
        ...
        <p>✅ สอนทำ คอนกรีตพิมพ์ลาย รุ่นที่13</p>
    </div>
    <div class="sec-text">
